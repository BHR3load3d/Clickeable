"""
Django settings for abmproj project.
...
SECRET_KEY = 'o!sor-+g2$ec1o_i2_#u8b55vf24jprsmn(rgga+1$pk_l=k9j'
...
WSGI_APPLICATION = 'abmproj.wsgi.application'
